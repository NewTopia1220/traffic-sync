...
| 팀원 | 역할 | 주요 담당 |
|:---:|:---:|---|
| **박하윤** (팀장) | **AI 에이전트** | ReAct 에이전트 + MCP 도구 · 멀티에이전트 신호 최적화 · 실시간 수집 파이프라인 · 캐싱·WebSocket 브로드캐스트 · 뉴스 파이프라인 |
| **장수아** | **프론트엔드 · 시각화** | 화면 구현·데이터 시각화 · 지도 기반 교차로 선택/상세 · VWorld 3D 주행 뷰 · 신호 운영계획 모델링·DB |
