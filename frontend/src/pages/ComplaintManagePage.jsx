  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 1000, background: "rgba(0,0,0,0.92)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div onClick={e => e.stopPropagation()} style={{ position: "relative" }}>
        ...
        <button onClick={onClose} style={{ position: "absolute", top: -12, right: -12, width: 30, height: 30, background: V.bg1, border: `1px solid ${V.line}`, borderRadius: "50%", color: V.ink1, cursor: "pointer", fontSize: 16 }}>✕</button>
      </div>
    </div>
  );
}
